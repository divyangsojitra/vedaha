<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerReg.aspx.cs" MasterPageFile="~/AdminMaster.master"   Inherits="CustomerReg" %>
...
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
  ...
  <asp:Label runat="server" ID="Lbltype" Text="User" Visible="false"></asp:Label>
   <table runat="server" id="TblAddEdit" visible="true">
       ...
       <tr>
            <td>
                ...
                <Controls:Captcha ID="captcha1" Message="Please enter text shown below:" runat="server"
      BackgroundColor="#ffffff"  />
       ...
       <tr>
          <td>
            <asp:Button runat="server" ID="ButcontinuousShopping" Text="Continuous Shopping" 
                  CommandName="ButcontinuousSopping" onclick="ButcontinuousShopping_Click" />
          </td>
       </tr>  
   </table>
